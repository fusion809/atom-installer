...
#  export _language_rpm_spec_url="waveclaw/language-rpm-spec"
#  export _language_rpm_spec_ver=$(pkg_det ${_language_rpm_spec_url})
  ...
  export _language_vala_modern_ver=$(pkg_det fusion809/language-vala-modern)
